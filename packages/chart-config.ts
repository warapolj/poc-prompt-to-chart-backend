...
export interface ShadcnChartConfig {
  type: ChartType
  dataFormat: 'simple' | 'multiple' | 'time-series' | 'scatter' | 'radial'
...
export const SHADCN_CHART_CONFIGS: Record<ChartType, ShadcnChartConfig> = {
  bar: {
    type: 'bar',
    dataFormat: 'simple',
...
export function formatDataForShadcn(
  chartType: ChartType,
  rawData: any[],
): {
  data: any[]
...
export function getShadcnChartComponent(chartType: ChartType): string {
...
export function generateShadcnChartResponse(
  chartType: ChartType,
  rawData: any[],
  title: string,
  metadata: any = {},
